---
name: negin-root-cause-analysis
description: "Investigate enterprise KPI anomalies through systematic drill-down. Use when a business metric changes unexpectedly and evidence-backed causes are required."
...
Specialist workflow for business root-cause analysis through controlled decomposition.
...
1. Define and reproduce the anomaly.
2. Rule out data-quality artifacts.
3. Decompose across relevant business dimensions.
4. Rank contributors by impact.
5. Test competing hypotheses and preserve uncertainty.
