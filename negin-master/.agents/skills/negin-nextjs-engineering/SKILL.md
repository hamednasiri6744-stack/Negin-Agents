---
name: negin-nextjs-engineering
description: "Engineer Next.js applications. Use for App Router, server/client components, routing, data fetching, caching, route handlers and deployment behavior."
...
Specialist workflow for correct Next.js server/client, routing and cache architecture.
...
1. Inspect Next.js version and router.
2. Choose server/client boundaries deliberately.
3. Define freshness and cache semantics.
4. Keep secrets server-side.
5. Verify build and runtime routes.
