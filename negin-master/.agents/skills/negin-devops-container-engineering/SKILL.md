---
name: negin-devops-container-engineering
description: "Engineer and operate containerized environments. Use for Podman/Docker, images, compose, volumes, networking, health checks, startup, recovery and deployment automation."
...
Specialist workflow for recoverable and observable container operations.
...
2. Map containers, ports, volumes and dependencies.
3. Protect persistent data before repair/recreate operations.
4. Use explicit health checks.
5. Test restart and recovery.
