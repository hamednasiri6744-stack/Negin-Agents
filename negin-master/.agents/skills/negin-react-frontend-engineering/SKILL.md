---
name: negin-react-frontend-engineering
description: "Build and improve React user interfaces. Use for components, state, forms, accessibility, responsiveness, rendering performance and frontend debugging."
...
Specialist workflow for maintainable, accessible React UI engineering.
...
1. Define loading, error, empty and success states.
2. Keep state as local as practical.
3. Avoid unnecessary effects.
4. Check accessibility and responsive behavior.
5. Run lint, type and interaction tests.
