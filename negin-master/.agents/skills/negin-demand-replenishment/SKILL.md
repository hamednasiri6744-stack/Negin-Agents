---
name: negin-demand-replenishment
description: "Estimate demand and replenishment priorities from verified history and business constraints. Use for replenishment planning, demand signals, shortage prevention and stock scenarios."
...
Specialist workflow for demand estimation and replenishment decision support.
...
1. Clean and align historical periods.
2. Identify trend, seasonality and exceptional events.
3. Establish a simple baseline before complex models.
4. Quantify uncertainty.
5. Translate demand into replenishment priorities without executing orders.
